 ...
 */
@ActivityScope
public class TrackBaiduPresenter extends BasePresenter<TrackBaiduContract.Model, TrackBaiduContract.View> {
    @Inject
    ...
    @Inject
    public TrackBaiduPresenter(TrackBaiduContract.Model model, TrackBaiduContract.View rootView) {
