...
//        else if(PerionLocationAddActivity.isWheelView){
//            controlWidth=CommonUtils.getScreenWidth(getContext())/2;
//            setMeasuredDimension((int)controlWidth, itemNumber * unitHeight);
//        }else if(AskRecordActivity.isWheelView){
//            controlWidth=CommonUtils.getScreenWidth(getContext());
//            setMeasuredDimension((int)controlWidth, itemNumber * unitHeight);
//        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        lineColor = attribute.getColor(R.styleable.WheelView_lineColor,
                0xff000000);
        bottomLineColor = attribute.getColor(R.styleable.WheelView_bottomLineColorWheel,
                0xffDADADA);
