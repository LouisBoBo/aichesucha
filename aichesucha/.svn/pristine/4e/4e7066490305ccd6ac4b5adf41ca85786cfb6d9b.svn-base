 ...
 */
@ActivityScope
public class BindForeignPresenter extends BasePresenter<BindForeignContract.Model, BindForeignContract.View> {
    @Inject
    ...
    @Inject
    public BindForeignPresenter(BindForeignContract.Model model, BindForeignContract.View rootView) {
