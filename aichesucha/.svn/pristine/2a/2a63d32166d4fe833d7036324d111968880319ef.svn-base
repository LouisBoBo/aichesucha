...
public class AddAccountPresenter extends BasePresenter<AddAccountContract.Model, AddAccountContract.View> {
    ...
    @Inject
    public AddAccountPresenter (AddAccountContract.Model model, AddAccountContract.View rootView) {
        super(model, rootView);
    }

    public void submitAddAccount(AddAccountPutBean bean){
        mModel.submitAddAccount(bean)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseBean>(mErrorHandler) {
                    ...
                    public void onNext(BaseBean baseBean) {
                        if (baseBean.isSuccess()){
                            mRootView.submitAddAccountSuccess(baseBean);
                        }
                    }
                });
    }
