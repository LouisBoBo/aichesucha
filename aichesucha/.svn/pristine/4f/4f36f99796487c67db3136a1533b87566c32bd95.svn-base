 ...
 */
@ActivityScope
public class IconCheckPresenter extends BasePresenter<IconCheckContract.Model, IconCheckContract.View> {
    @Inject
    ...
    @Inject
    public IconCheckPresenter (IconCheckContract.Model model, IconCheckContract.View rootView) {
