...
//    private int circleColor = Color.BLACK;
    private int circleColor = getResources().getColor(R.color.color_FF7D12);

    /**
     * 底部线的颜色   默认GRAY
     */
//    private int bottomLineColor = Color.GRAY;
    private int bottomLineColor = getResources().getColor(R.color.color_FF6D27);
    ...
    private void initPaint() {
        ...
        bottomLinePaint = getPaint(4, Paint.Style.FILL, bottomLineColor);
