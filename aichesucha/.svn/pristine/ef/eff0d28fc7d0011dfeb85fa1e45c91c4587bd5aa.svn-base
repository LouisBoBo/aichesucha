...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.car.scth.mvp.ui.view.data.haibin.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.car.scth.mvp.ui.view.data.haibin.WeekBar".equalsIgnoreCase(getClass().getName())) {
