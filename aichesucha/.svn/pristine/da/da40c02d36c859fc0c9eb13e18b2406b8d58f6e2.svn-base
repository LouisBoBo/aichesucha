 ...
 */
@ActivityScope
public class DeviceManagementModel extends BaseModel implements DeviceManagementContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DeviceManagementModel(IRepositoryManager repositoryManager) {
