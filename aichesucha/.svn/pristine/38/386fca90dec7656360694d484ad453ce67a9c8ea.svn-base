...
public class LocationAmapPresenter extends BasePresenter<LocationAmapContract.Model, LocationAmapContract.View> {
    ...
    @Inject
    public LocationAmapPresenter (LocationAmapContract.Model model, LocationAmapContract.View rootView) {
...
//                    }
     ...
     * @param bean
     */
    public void getDeviceDetailInfo(DeviceDetailPutBean bean, String state, int power, long time){
                ...
                .subscribe(new ErrorHandleSubscriber<DeviceDetailResultBean>(mErrorHandler) {
                    ...
                    public void onNext(DeviceDetailResultBean deviceDetailResultBean) {
                        if (deviceDetailResultBean.isSuccess()){
                            mRootView.getDeviceDetailInfoSuccess(deviceDetailResultBean, state, power, time);
