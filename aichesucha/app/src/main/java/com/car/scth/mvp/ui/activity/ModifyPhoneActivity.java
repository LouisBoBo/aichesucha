...
import com.car.scth.di.component.DaggerModifyPhoneComponent;
...
import com.car.scth.mvp.presenter.ModifyPhonePresenter;
...
public class ModifyPhoneActivity extends BaseActivity<ModifyPhonePresenter> implements ModifyPhoneContract.View {
    ...
    private void submitBindMobile() {
        ...
        if (TextUtils.isEmpty(mobile)) {
            ToastUtils.show(getString(R.string.txt_input_new_phone));
            return;
        }
