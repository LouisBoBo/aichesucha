 ...
 */
@ActivityScope
public class SysSettingActivityModel extends BaseModel implements SysSettingActivityContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public SysSettingActivityModel(IRepositoryManager repositoryManager) {
