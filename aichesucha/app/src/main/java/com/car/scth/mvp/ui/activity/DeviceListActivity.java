...
import com.car.scth.di.component.DaggerDeviceListComponent;
...
import com.car.scth.mvp.presenter.DeviceListPresenter;
...
public class DeviceListActivity extends BaseActivity<DeviceListPresenter> implements DeviceListContract.View {
    ...
    @BindView(R.id.v_indicator_all)
    View vAll;
    @BindView(R.id.v_indicator_online)
    View vOnline;
    @BindView(R.id.v_indicator_static)
    View vStatic;
    @BindView(R.id.v_indicator_offline)
    View vOffline;
...
//        setTitle(getString(R.string.txt_device_management));
        ...
        toolbarIvRight.setImageResource(R.mipmap.icon_device_list_set);
...
//        if (TextUtils.isEmpty(mSid)) { // 查看所有设备
//            mAdapter.setShowAll(true);
//            toolbarIvRight.setVisibility(View.INVISIBLE);
//        }
    ...
    @OnClick({R.id.toolbar_iv_right, R.id.ll_device_list_all, R.id.ll_device_list_online, R.id.ll_device_list_static, R.id.ll_device_list_offline})
        ...
        if (Utils.isButtonQuickClick(System.currentTimeMillis())) {
            switch (view.getId()) {
                case R.id.toolbar_iv_right:
                    ...
                    break;
                case R.id.ll_device_list_all:
                    onDeviceListScreen("");
                    break;
                case R.id.ll_device_list_online:
                    onDeviceListScreen(ResultDataUtils.Device_State_Line_On);
                    break;
                case R.id.ll_device_list_static:
                    onDeviceListScreen(ResultDataUtils.Device_State_Line_Sleep);
                    break;
                case R.id.ll_device_list_offline:
    ...
    private void onDeviceStatusShow() {
        int colorSelect = getResources().getColor(R.color.color_00A8FF);
        int colorUnSelect = getResources().getColor(R.color.color_666666);
        ...
        vOnline.setVisibility(View.INVISIBLE);
        vStatic.setVisibility(View.INVISIBLE);
        vOffline.setVisibility(View.INVISIBLE);
        if (TextUtils.isEmpty(deviceStatus)) {
