 ...
 */
@ActivityScope
public class FlyModePresenter extends BasePresenter<FlyModeContract.Model, FlyModeContract.View> {
    @Inject
    ...
    @Inject
    public FlyModePresenter(FlyModeContract.Model model, FlyModeContract.View rootView) {
