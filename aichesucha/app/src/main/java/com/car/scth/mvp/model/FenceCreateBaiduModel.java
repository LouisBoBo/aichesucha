 ...
 */
@ActivityScope
public class FenceCreateBaiduModel extends BaseModel implements FenceCreateBaiduContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public FenceCreateBaiduModel(IRepositoryManager repositoryManager) {
