...
import com.car.scth.di.component.DaggerHomeComponent;
import com.car.scth.mvp.contract.HomeContract;
import com.car.scth.mvp.presenter.HomePresenter;
 ...
 * Description:
 * <p>
 * Created by MVPArmsTemplate on 10/22/2020 16:38
...
public class HomeFragment extends BaseFragment<HomePresenter> implements HomeContract.View{
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerHomeComponent //如找不到该类,请编译一下项�?
                .builder()
