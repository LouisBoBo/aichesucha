 ...
 */
@ActivityScope
public class RealTimeTrackAmapPresenter extends BasePresenter<RealTimeTrackAmapContract.Model, RealTimeTrackAmapContract.View> {
    @Inject
    ...
    @Inject
    public RealTimeTrackAmapPresenter (RealTimeTrackAmapContract.Model model, RealTimeTrackAmapContract.View rootView) {
