...
public class AlertAppRightDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        ViewGroup viewGroup = (ViewGroup) View.inflate(getActivity(), R.layout.dialog_alert_right, null);
    ...
    private void initView(Dialog dialog) {
        ...
        switch (alertBean.getType()){
            case 0:
                mBtnCancel.setText(getString(R.string.txt_cancel));
                mBtnConfirm.setText(getString(R.string.txt_confirm));
                break;
            case 1:
                mBtnCancel.setText(getString(R.string.txt_not_open));
                mBtnConfirm.setText(getString(R.string.txt_open));
                break;
        }
    ...
    public void show(FragmentManager manager, AlertBean bean, onAlertDialogChange change){
        ...
        super.show(manager, "AlertAppRightDialog");
    }
