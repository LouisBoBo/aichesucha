 ...
 */
@ActivityScope
public class UserInfoModifyModel extends BaseModel implements UserInfoModifyContract.Model{
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public UserInfoModifyModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseBean> submitModifyUserInfo(ModifyPasswordPutBean bean) {
        Gson gson = new Gson();
