...
public class ResultDataUtils {
     ...
     * 围栏报警类型
     *
     * @param fence_switch 报警类型
     * @return
     */
    public static String getFenceAlarmSwitch(String fence_switch) {
        String alarmType = "";
        switch (fence_switch) {
            case Fence_Alarm_In:
                alarmType = MyApplication.getMyApp().getString(R.string.txt_alarm) + MyApplication.getMyApp().getString(R.string.txt_fence_switch_in);
                break;
            case Fence_Alarm_Out:
                alarmType = MyApplication.getMyApp().getString(R.string.txt_alarm) + MyApplication.getMyApp().getString(R.string.txt_fence_switch_out);
                break;
            case Fence_Alarm_In_Out:
                alarmType = MyApplication.getMyApp().getString(R.string.txt_alarm) + MyApplication.getMyApp().getString(R.string.txt_fence_switch_in_out);
                break;
            case Fence_Alarm_Close:
                alarmType = MyApplication.getMyApp().getString(R.string.txt_alarm) + MyApplication.getMyApp().getString(R.string.txt_fence_switch_close);
                break;
     ...
     * @return
     */
    public static String getFenceType(String type) {
        String fenceType = "";
        switch (type) {
            case Fence_Round:
                fenceType = MyApplication.getMyApp().getString(R.string.txt_type) + MyApplication.getMyApp().getString(R.string.txt_round_fence);
                break;
            case Fence_Polygonal:
                fenceType = MyApplication.getMyApp().getString(R.string.txt_type) + MyApplication.getMyApp().getString(R.string.txt_polygonal_fence);
                break;
            case Fence_City:
                fenceType = MyApplication.getMyApp().getString(R.string.txt_type) + MyApplication.getMyApp().getString(R.string.txt_city_fence);
                break;
        }
        return fenceType;
    }
    ...
    public static String convertTimemills(long diff, Context context) {
        ...
        return days + context.getString(R.string.txt_day)
                + hours + context.getString(R.string.txt_hour)
    ...
    public static void setElectricImageData(int power, TextView tvEle) {
        tvEle.setText(power + "%");
        if (power == 0) {
            tvEle.setBackgroundResource(R.mipmap.ic_map_ele1);
        } else if (power > 0 && power <= 5) {
            tvEle.setBackgroundResource(R.mipmap.ic_map_ele1);
        } else if (power > 5 && power <= 25) {
            tvEle.setBackgroundResource(R.mipmap.ic_map_ele2);
        } else if (power > 25 && power <= 50) {
            tvEle.setBackgroundResource(R.mipmap.ic_map_ele3);
        } else if (power > 50 && power <= 75) {
            tvEle.setBackgroundResource(R.mipmap.ic_map_ele4);
        } else if (power > 75 && power <= 100) {
            tvEle.setBackgroundResource(R.mipmap.ic_map_ele5);
        }
    }
     ...
     * @return
     */
    public static String getLocationMode(Context context, String mode, String version,String mode_fun) {
        String locationMode = context.getString(R.string.txt_location_mode_1);
        switch (mode) {
            case Device_Mode_Nomal:
                if (!TextUtils.isEmpty(mode_fun)){
                    if (mode_fun.equals(ResultDataUtils.Mode_Stand_By_Location)){
                        locationMode = context.getString(R.string.txt_location_mode_1);
                    }else{
                        locationMode = context.getString(R.string.txt_location_mode_error);
                    }
                }else{
                    locationMode = context.getString(R.string.txt_location_mode_1);
                }
            ...
            case ResultDataUtils.Device_Mode_Nomal_X7:
                locationMode = context.getString(R.string.txt_location_mode_1);
                break;
            case Device_Mode_Looploc:
                locationMode = context.getString(R.string.txt_location_mode_2);
                break;
            case Device_Mode_Fly:
                locationMode = context.getString(R.string.txt_location_mode_3);
                break;
            case Device_Mode_Sup_Save_Power:
                locationMode = context.getString(R.string.txt_location_mode_4);
                break;
            case Device_Mode_Auto_Save_Power:
                break;
            case Device_Mode_Sleep:
                locationMode = context.getString(R.string.txt_location_mode_6);
                break;
            case Device_Mode_Save_Power:
                locationMode = context.getString(R.string.txt_location_mode_7);
                break;
            case Device_Mode_Call_One:
            case Device_Mode_Sup_Save_Power_C2:
                if (version.toUpperCase().contains(FunctionType.C2)) {
                    locationMode = context.getString(R.string.txt_location_mode_1);
                } else {
                    locationMode = context.getString(R.string.txt_location_mode_8);
                }
                break;
        }
        return locationMode;
