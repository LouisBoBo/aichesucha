...
import com.car.scth.mvp.ui.adapter.DeviceFailAdapter;
...
public class DeviceFailDialog extends DialogFragment {
    ...
    private void initView(Dialog dialog) {
        ...
        switch (mType){
            case 0:
                tvTitle.setText(getString(R.string.txt_add_device_fail) + " (" + failItemsBeans.size() + ")");
                break;
            case 1:
                tvTitle.setText(getString(R.string.txt_transfer_device_fail) + " (" + failItemsBeans.size() + ")");
                break;
            case 2:
                tvTitle.setText(getString(R.string.txt_fence_device_fail) + " (" + failItemsBeans.size() + ")");
                break;
            case 3:
                tvTitle.setText(getString(R.string.txt_delete_device_fail) + " (" + failItemsBeans.size() + ")");
                break;
            case 4:
                tvTitle.setText(getString(R.string.txt_freeze_equipment_device_fail) + " (" + failItemsBeans.size() + ")");
                break;
            case 5:
                tvTitle.setText(getString(R.string.txt_restore_device_fail) + " (" + failItemsBeans.size() + ")");
                break;
            case 6:
                tvTitle.setText(getString(R.string.txt_delete_fail) + " (" + failItemsBeans.size() + ")");
                break;
            case 7:
                tvTitle.setText(getString(R.string.txt_unbind_phone_fail) + " (" + failItemsBeans.size() + ")");
                break;
        }
