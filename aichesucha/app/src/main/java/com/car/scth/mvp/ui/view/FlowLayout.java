...
public class FlowLayout extends ViewGroup {
	...
	private View mLastView; //上次被选中的view
	public View getmLastView() {
		return mLastView;
	}

	public void setmLastView(View mLastView) {
	...
	private View mCurrentView; //当前选中的子view
	...
	//用于内部 子view的监听 
	ChildViewClikListener mListener=new ChildViewClikListener();
	private class ChildViewClikListener implements OnClickListener {
		@Override
		public void onClick(View v) {
//			if(v==mCurrentView){ //避免重复点击
//				return;
//			}
			mCurrentView = v; //保存最后被点击的view
