...
public class SmoothMarker {
    ...
    public SmoothMarker(AMap mAMap, int iconid) {
        this.mAMap = mAMap;
        this.iconId = iconid;
    }
    ...
    private void setEndRotate() {
        ...
        float rotate = getRotate(lastEndPoint.getPoint(), endPoint.getPoint());
        if (iconId == 0 || iconId == 1 || iconId == 2) {
            marker.setRotateAngle(360 - rotate + mAMap.getCameraPosition().bearing);
        }else{
