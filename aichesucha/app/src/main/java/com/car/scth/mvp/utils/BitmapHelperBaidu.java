...
public class BitmapHelperBaidu {
     ...
     * 初始化图标的bitmap
     */
    public BitmapHelperBaidu(Context context) {

        Bitmap startBitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_track_qi);
        Bitmap endBitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_track_zhong);
        Bitmap parkingBitmap = BitmapFactory.decodeResource(context.getResources(),R.mipmap.icon_track_p);
        Bitmap userBitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_user_location);
        ...
        baseStationBitmap.eraseColor(Color.RED);
