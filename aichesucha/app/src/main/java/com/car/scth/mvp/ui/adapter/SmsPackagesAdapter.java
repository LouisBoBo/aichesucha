 ...
 * sim卡充值-短信套餐
 */
public class SmsPackagesAdapter extends CommonAdapter<RechargePackagesResultBean.AddoptionalBean> {

    public SmsPackagesAdapter(Context context, int layoutId, List<RechargePackagesResultBean.AddoptionalBean> datas) {
        super(context, layoutId, datas);
    }

    @SuppressLint("SetTextI18n")
    @Override
    protected void convert(ViewHolder viewHolder, RechargePackagesResultBean.AddoptionalBean item, int position) {
